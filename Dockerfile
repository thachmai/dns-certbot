...
ENTRYPOINT ["/usr/bin/certbot", "--manual", "--manual-auth-hook", "/usr/local/bin/acme-dns-auth.py", "--preferred-challenges", "dns", "--agree-tos", "--manual-public-ip-logging-ok", "--server", "https://acme-v02.api.letsencrypt.org/directory"]